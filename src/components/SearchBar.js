...
export default function SearchBar({setData, setIsLoading, setShowFavorites}) {
    ...
    return ( 
        <div className="items-center flex-none w-2/4 my-6 md:flex">
            <form method="get" className="flex flex-col items-center justify-center md:flex-row">
                ...
                <input className="block px-4 my-2 text-white border rounded-md md:ml-4 bg-zinc-600 w-fit " 
